// Declarar una constructor Class de ES6 llamada Usuario que reciba: nombre (string), apellido (string), libros (array de objetos) y mascotas (array de strings). 
...
let lucas = new Usuario('Lucas', 'Marina', [{nombre: 'El señor de las moscas',autor: 'William Golding'}, {nombre: 'Fundacion', autor: 'Isaac Asimov'}],['Yago','Kira']);

console.log(lucas.getFullName());
// lucas.addBook('Harry Potter y la piedra filosofal', 'J. K. Rowling');
console.log(lucas.getBooks());
// lucas.addMascotas('luis');
