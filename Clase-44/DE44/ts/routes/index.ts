...
import RouterProductos, { RouterProductosGraphQL } from "../routes/productos.routes";
...
const routerProductosGraphQL = new RouterProductosGraphQL()
...
router.use('/gr', routerProductosGraphQL.start())
